      ...
      <div className="w-full max-w-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/80 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/90">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">Add an operational record directly linked to the firm</p>
          </div>
          <button
        ...
        {/* Tab Selection */}
        <div className="flex border-b border-slate-200 dark:border-slate-800 bg-slate-100/60 dark:bg-slate-950/50 px-3 overflow-x-auto text-xs font-medium">
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-2.5 border-b-2 transition whitespace-nowrap ${
              activeTab === 'matter' ? 'border-amber-600 text-amber-700 dark:border-amber-500 dark:text-amber-400 font-semibold' : 'border-transparent text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-200'
            }`}
          >
