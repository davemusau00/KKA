    ...
    <div className="space-y-6 pb-20">
      ...
      {selectedContact && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex justify-end">
          <div className="w-full max-w-lg bg-slate-900 border-l border-slate-800 h-full p-6 overflow-y-auto space-y-6 animate-in slide-in-from-right">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div>
                ...
                <h2 className="text-lg font-serif font-bold text-slate-100 mt-2">
                  {selectedContact.name}
                </h2>
                {selectedContact.organizationName && (
                  <p className="text-xs text-slate-400">{selectedContact.organizationName}</p>
                )}
              </div>
              <button
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto text-xs">
