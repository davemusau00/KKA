...
export const AppShell: React.FC<Props> = ({ children }) => {
  ...
  const allNavigationItems = [
    ...
    { id: 'operations', label: 'Operations & HR', icon: Building2, permission: null },
    { id: 'knowledge', label: 'Knowledge', icon: FileText, permission: 'module.knowledge' as const },
    { id: 'help', label: 'Help Center', icon: Sparkles, permission: null },
    { id: 'reports', label: 'Reports & Stalled', icon: BarChart3, permission: 'module.reports' as const },
    { id: 'website', label: 'Website & Growth', icon: ExternalLink, permission: 'website.view' as any },
