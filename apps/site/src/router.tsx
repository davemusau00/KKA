...
const indexRoute=createRoute({getParentRoute:()=>rootRoute,path:'/',component:()=>{const data=rootRoute.useLoaderData() as SiteBootstrap;return <ContentPage slug="home" data={data}/>}});
const aboutRoute=createRoute({getParentRoute:()=>rootRoute,path:'/about',component:()=>{const data=rootRoute.useLoaderData() as SiteBootstrap;return <ContentPage slug="about" data={data}/>}});
const practiceIndex=createRoute({getParentRoute:()=>rootRoute,path:'/practice-areas',component:()=>{const data=rootRoute.useLoaderData() as SiteBootstrap;return <ContentPage slug="practice-areas" data={data}/>}});
...
const teamIndex=createRoute({getParentRoute:()=>rootRoute,path:'/team',component:()=>{const data=rootRoute.useLoaderData() as SiteBootstrap;return <ContentPage slug="team" data={data}/>}});
...
const insightsIndex=createRoute({getParentRoute:()=>rootRoute,path:'/insights',component:()=>{const data=rootRoute.useLoaderData() as SiteBootstrap;return <ContentPage slug="insights" data={data}/>}});
...
const contactRoute=createRoute({getParentRoute:()=>rootRoute,path:'/contact',component:()=>{const data=rootRoute.useLoaderData() as SiteBootstrap;return <ContentPage slug="contact" data={data}/>}});
