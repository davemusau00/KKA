...
export type SiteLogos={default?:MediaAsset|null;dark?:MediaAsset|null;light?:MediaAsset|null;mark?:MediaAsset|null};
export type SiteSettings={firmName:string;tagline:string;phone:string;email:string;address:string;socials:{label:string;url:string}[];navigation?:{label:string;url:string}[];footer?:Record<string,unknown>;defaultSeo?:Record<string,unknown>;theme?:Record<string,unknown>;logos?:SiteLogos};
