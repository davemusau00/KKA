...
export type Publication={id:string;slug:string;kind:'ARTICLE'|'VIDEO';title:string;excerpt:string;body:string;cover:MediaAsset|null;publishedAt:string;author?:Partner;duration?:string;videoUrl?:string;captionsUrl?:string;practiceAreas:string[];tags?:string[];seo?:Record<string,unknown>};
